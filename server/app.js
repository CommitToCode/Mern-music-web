...
app.use(session({
  ...
  cookie: {
    ...
    httpOnly: true,
    secure: false,  // works both locally and on Vercel (change dynamically if needed)
    sameSite: 'lax' // works both locally and on Vercel
  }
}));
...
app.post('/api/logout', (req, res) => {
  req.session.destroy(err => {
    ...
    res.clearCookie('connect.sid', { path: '/', sameSite: 'none', secure: false });
