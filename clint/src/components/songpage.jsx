          ...
          return (
            <div key={song._id} style={styles.card}>
              <div style={styles.imageWrapper}>
                <img
                  src={`https://res.cloudinary.com/da39aeyvi/image/upload/${song.imageUrl || '/images/default-cover.png'}`}
                  alt={song.title}
                  style={styles.img}
                />
              ...
              {song.fileUrl && (
                <>
                  ...
                  >
                    <source src={`https://res.cloudinary.com/da39aeyvi/video/upload/${song.fileUrl}`} type="audio/mpeg" />
                  </audio>
                  {isPlaying && (
