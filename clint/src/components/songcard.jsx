...
export default function SongCard({ song }) {
  ...
  return (
    <div style={cardStyle}>
      <img
        src={`https://res.cloudinary.com/da39aeyvi/image/upload/${song.imageUrl || "1752730434639_ma50fb.jpg"}`} 
      ...
      {song.isActive && song.fileUrl ? (
        <>
          <audio
            controls
            src={`https://res.cloudinary.com/da39aeyvi/video/upload/${song.fileUrl}`}
            style={audioStyle}
          />
          {isLoggedIn ? (
            <ProtectedDownload url={`https://res.cloudinary.com/da39aeyvi/video/upload/${song.fileUrl}`} />
          ) : (
